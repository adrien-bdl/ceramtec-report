...
\textcolor{red}{[TODO: describe CeramTec's current pricing policy --- list-price structure, OEM contract mechanics, geographic price differentiation, and discount/escalation rules. Requires internal CeramTec input.]}
...
\section{CeramTec Business Context}
...
\subsection{Customer base and competitive landscape}
...
\subsection{Bearing products and clinical--commercial relevance}
...
\textbf{Geographic markets} (per CeramTec direction): United States, China, France, and Italy. Germany, the United Kingdom, and LATAM were explicitly excluded from Phase~1 scope.
